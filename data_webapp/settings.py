...
SECRET_KEY = 'django-insecure-343g)k8^(j1imv=2ak3t7vl2+f2uj%1r7im&x^awrrh$i__+&$'
...
EMAIL_HOST_PASSWORD = 'qnoxgjwwhbsbrfzg'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    #'core.social_pipeline.check_user_exists',  # custom pipeline function
    'social_core.pipeline.user.create_user',
    #'core.social_pipeline.set_email_verified',  # custom pipeline function
